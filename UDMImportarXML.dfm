object DMImportarXML: TDMImportarXML
  ...
  object mItensNota: TClientDataSet
    ...
    Top = 488
    Data = {
      1C0600009619E0BD0100000018000000420000000000030000001C0604497465
      ...
      6C72494F460800040000000000064D6F64656C6F010049000000010005574944
      544802000200020001000D44454641554C545F4F524445520200820000000000}
    ...
    object mItensNotaModelo: TStringField
      FieldName = 'Modelo'
      Size = 2
    end
  end
  ...
  object sdsFilial: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'SELECT ID, NOME, NOME_INTERNO, CNPJ_CPF, ID_CIDADE'#13#10'FROM FILIAL'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = dmDatabase.scoDados
    Left = 120
  ...
  object qSPEDXML: TSQLQuery
    ...
    SQL.Strings = (
      'SELECT S.ID, S.NUM_NOTA, S.MODELO, S.TIPO_ES'
      'FROM SPEDXML S'
      'WHERE S.MODELO = :MODELO'
      '  AND S.NUM_NOTA = :NUM_NOTA'
      '  AND S.SERIE = :SERIE'
      '  AND S.EMIT_CNPJ_CPF = :EMIT_CNPJ_CPF')
    SQLConnection = dmDatabase.scoDados
    Left = 688
    Top = 240
    object qSPEDXMLID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object qSPEDXMLNUM_NOTA: TIntegerField
      FieldName = 'NUM_NOTA'
    end
    object qSPEDXMLMODELO: TStringField
      FieldName = 'MODELO'
      Size = 2
    end
    object qSPEDXMLTIPO_ES: TStringField
      FieldName = 'TIPO_ES'
      Size = 2
    end
  end
  ...
  object sdsMovimento: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'SELECT *'#13#10'FROM MOVIMENTO'#13#10'WHERE ID = :ID'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    object sdsMovimentoVLR_AJUSTE_CUSTO: TFloatField
      FieldName = 'VLR_AJUSTE_CUSTO'
    end
    object sdsMovimentoCHAVE_ACESSO: TStringField
      FieldName = 'CHAVE_ACESSO'
      Size = 44
    end
    object sdsMovimentoTIPO_FRETE: TSmallintField
      FieldName = 'TIPO_FRETE'
    end
    object sdsMovimentoID_SPED_DOC: TIntegerField
      FieldName = 'ID_SPED_DOC'
    end
    object sdsMovimentoCOD_CST_ICMS: TStringField
      FieldName = 'COD_CST_ICMS'
      Size = 3
    end
    object sdsMovimentoORIGEM_PROD: TStringField
      FieldName = 'ORIGEM_PROD'
      Size = 1
    end
    object sdsMovimentoPERC_ICMS_ST: TFloatField
      FieldName = 'PERC_ICMS_ST'
    end
    object sdsMovimentoCOD_CST_IPI: TStringField
      FieldName = 'COD_CST_IPI'
      Size = 2
    end
    object sdsMovimentoCOD_CST_PIS: TStringField
      FieldName = 'COD_CST_PIS'
      Size = 2
    end
    object sdsMovimentoCOD_CST_COFINS: TStringField
  ...
  object cdsMovimento: TClientDataSet
    ...
    object cdsMovimentoVLR_AJUSTE_CUSTO: TFloatField
      FieldName = 'VLR_AJUSTE_CUSTO'
    end
    object cdsMovimentoCHAVE_ACESSO: TStringField
      FieldName = 'CHAVE_ACESSO'
      Size = 44
    end
    object cdsMovimentoTIPO_FRETE: TSmallintField
      FieldName = 'TIPO_FRETE'
    end
    object cdsMovimentoID_SPED_DOC: TIntegerField
      FieldName = 'ID_SPED_DOC'
    end
    object cdsMovimentoCOD_CST_ICMS: TStringField
      FieldName = 'COD_CST_ICMS'
      Size = 3
    end
    object cdsMovimentoORIGEM_PROD: TStringField
      FieldName = 'ORIGEM_PROD'
      Size = 1
    end
    object cdsMovimentoPERC_ICMS_ST: TFloatField
      FieldName = 'PERC_ICMS_ST'
    end
    object cdsMovimentoCOD_CST_IPI: TStringField
      FieldName = 'COD_CST_IPI'
      Size = 2
    end
    object cdsMovimentoCOD_CST_PIS: TStringField
      FieldName = 'COD_CST_PIS'
      Size = 2
    end
    object cdsMovimentoCOD_CST_COFINS: TStringField
      FieldName = 'COD_CST_COFINS'
      Size = 10
    end
  end
  ...
  object sdsSped_Doc: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'SELECT *'#13#10'FROM SPED_DOC'#13#10'WHERE ID = :ID'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 424
    Top = 24
    object sdsSped_DocID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object sdsSped_DocID_PESSOA: TIntegerField
      FieldName = 'ID_PESSOA'
    end
    object sdsSped_DocIND_EMITENTE: TIntegerField
      FieldName = 'IND_EMITENTE'
    end
    object sdsSped_DocTIPO_ES: TSmallintField
      FieldName = 'TIPO_ES'
    end
    object sdsSped_DocMODELO: TStringField
      FieldName = 'MODELO'
      Size = 2
    end
    object sdsSped_DocCOD_SIT: TStringField
      FieldName = 'COD_SIT'
      Size = 2
    end
    object sdsSped_DocSERIE: TStringField
      FieldName = 'SERIE'
      Size = 3
    end
    object sdsSped_DocNUM_DOC: TStringField
      FieldName = 'NUM_DOC'
      Size = 9
    end
    object sdsSped_DocCHAVE_ACESSO: TStringField
      FieldName = 'CHAVE_ACESSO'
      Size = 44
    end
    object sdsSped_DocDTEMISSAO: TDateField
      FieldName = 'DTEMISSAO'
    end
    object sdsSped_DocDTES: TDateField
      FieldName = 'DTES'
    end
    object sdsSped_DocVLR_TOTAL: TFloatField
      FieldName = 'VLR_TOTAL'
    end
    object sdsSped_DocIND_PAGTO: TSmallintField
      FieldName = 'IND_PAGTO'
    end
    object sdsSped_DocVLR_DESCONTO: TFloatField
      FieldName = 'VLR_DESCONTO'
    end
    object sdsSped_DocVLR_ABATIMENTO_ICMS: TFloatField
      FieldName = 'VLR_ABATIMENTO_ICMS'
    end
    object sdsSped_DocVLR_PRODUTOS: TFloatField
      FieldName = 'VLR_PRODUTOS'
    end
    object sdsSped_DocTIPO_FRETE: TSmallintField
      FieldName = 'TIPO_FRETE'
    end
    object sdsSped_DocVLR_FRETE: TFloatField
      FieldName = 'VLR_FRETE'
    end
    object sdsSped_DocVLR_SEGURO: TFloatField
      FieldName = 'VLR_SEGURO'
    end
    object sdsSped_DocVLR_OUTRASDESP: TFloatField
      FieldName = 'VLR_OUTRASDESP'
    end
    object sdsSped_DocVLR_BASE_ICMS: TFloatField
      FieldName = 'VLR_BASE_ICMS'
    end
    object sdsSped_DocVLR_ICMS: TFloatField
      FieldName = 'VLR_ICMS'
    end
    object sdsSped_DocVLR_BASE_ICMS_ST: TFloatField
      FieldName = 'VLR_BASE_ICMS_ST'
    end
    object sdsSped_DocVLR_ICMS_ST: TFloatField
      FieldName = 'VLR_ICMS_ST'
    end
    object sdsSped_DocVLR_IPI: TFloatField
      FieldName = 'VLR_IPI'
    end
    object sdsSped_DocVLR_PIS: TFloatField
      FieldName = 'VLR_PIS'
    end
    object sdsSped_DocVLR_COFINS: TFloatField
      FieldName = 'VLR_COFINS'
    end
    object sdsSped_DocVLR_PIS_ST: TFloatField
      FieldName = 'VLR_PIS_ST'
    end
    object sdsSped_DocVLR_COFINS_ST: TFloatField
      FieldName = 'VLR_COFINS_ST'
    end
    object sdsSped_DocFILIAL: TIntegerField
      FieldName = 'FILIAL'
    end
    object sdsSped_DocCANCELADO: TStringField
      FieldName = 'CANCELADO'
      FixedChar = True
      Size = 1
    end
    object sdsSped_DocDTCANCELADO: TDateField
      FieldName = 'DTCANCELADO'
    end
    object sdsSped_DocDENEGADO: TStringField
      FieldName = 'DENEGADO'
      FixedChar = True
      Size = 1
    end
    object sdsSped_DocMOTIVO_CANCELADO: TStringField
      FieldName = 'MOTIVO_CANCELADO'
      Size = 200
    end
    object sdsSped_DocMOTIVO_DENEGADO: TStringField
      FieldName = 'MOTIVO_DENEGADO'
      Size = 200
    end
    object sdsSped_DocREGIME_TRIB: TSmallintField
  ...
  object dsSped_Doc: TDataSource
    DataSet = cdsSped_Doc
    Left = 632
    Top = 24
  end
  object qConsulta_SPED_Doc: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftString
    ...
    SQL.Strings = (
      'SELECT  ID_PESSOA, NUM_DOC, SERIE'
      'FROM SPED_DOC'
      'WHERE CHAVE_ACESSO = :CHAVE_ACESSO')
    SQLConnection = dmDatabase.scoDados
    Left = 984
    Top = 352
    object qConsulta_SPED_DocID_PESSOA: TIntegerField
      FieldName = 'ID_PESSOA'
    end
    object qConsulta_SPED_DocNUM_DOC: TStringField
      FieldName = 'NUM_DOC'
      Size = 9
    end
    object qConsulta_SPED_DocSERIE: TStringField
      FieldName = 'SERIE'
      Size = 3
    end
  end
  object qMov: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'from movimento m'
      'where m.id_sped_doc = :id_sped'
      '  and m.item = :item')
    SQLConnection = dmDatabase.scoDados
    Left = 584
    Top = 256
    object qMovCONTADOR: TIntegerField
      FieldName = 'CONTADOR'
      Required = True
    end
  end
  object mCancelada: TClientDataSet
    Active = True
    Aggregates = <>
    FieldDefs = <
      item
    ...
    Top = 448
    Data = {
      620000009619E0BD0100000018000000030000000000030000006200084E4665
      43686176650100490000000100055749445448020002002C000943616E63656C
      6164610100490000000100055749445448020002000100044461746104000600
      000000000000}
    object mCanceladaNFeChave: TStringField
      DisplayWidth = 67
      FieldName = 'NFeChave'
      Size = 44
    end
    object mCanceladaCancelada: TStringField
      DisplayWidth = 24
      FieldName = 'Cancelada'
      Size = 1
    end
    object mCanceladaData: TDateField
      FieldName = 'Data'
    end
  end
  ...
  object qSped_Doc: TSQLQuery
    ...
    SQL.Strings = (
      'SELECT S.ID'
      'FROM SPED_DOC S'
      'WHERE S.CHAVE_ACESSO = :CHAVE_ACESSO')
    SQLConnection = dmDatabase.scoDados
    Left = 896
    Top = 552
    object qSped_DocID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
  end
  object sdsMov: TSQLDataSet
    NoMetadata = True
    GetMetadata = False
    CommandText = 'SELECT *'#13#10'FROM MOVIMENTO'#13#10'WHERE ID_SPED_DOC = :ID_SPED_DOC'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    object sdsMovITEM: TIntegerField
      FieldName = 'ITEM'
    end
    ...
    object sdsMovSERIE: TStringField
      FieldName = 'SERIE'
      Size = 3
    end
    ...
    object sdsMovID_SERVICO: TIntegerField
      FieldName = 'ID_SERVICO'
    end
    object sdsMovID_SERVICO_INT: TIntegerField
      FieldName = 'ID_SERVICO_INT'
    end
    object sdsMovID_NOTAFISCAL: TIntegerField
      FieldName = 'ID_NOTAFISCAL'
    end
    object sdsMovID_NOTASERVICO: TIntegerField
      FieldName = 'ID_NOTASERVICO'
    end
    object sdsMovID_CUPOMFISCAL: TIntegerField
      FieldName = 'ID_CUPOMFISCAL'
    end
    object sdsMovID_CFOP: TIntegerField
      FieldName = 'ID_CFOP'
    end
    object sdsMovID_PESSOA: TIntegerField
      FieldName = 'ID_PESSOA'
    end
    object sdsMovID_CLIENTETRIANG: TIntegerField
      FieldName = 'ID_CLIENTETRIANG'
    end
    object sdsMovFILIAL: TIntegerField
      FieldName = 'FILIAL'
    end
    object sdsMovVLR_UNITARIO: TFloatField
      FieldName = 'VLR_UNITARIO'
    end
    object sdsMovVLR_TOTAL: TFloatField
      FieldName = 'VLR_TOTAL'
    end
    object sdsMovVLR_DESCONTO: TFloatField
      FieldName = 'VLR_DESCONTO'
    end
    object sdsMovVLR_FRETE: TFloatField
      FieldName = 'VLR_FRETE'
    end
    object sdsMovVLR_ICMS: TFloatField
      FieldName = 'VLR_ICMS'
    end
    object sdsMovVLR_ICMSSUBST: TFloatField
      FieldName = 'VLR_ICMSSUBST'
    end
    object sdsMovVLR_ICMSSIMPLES: TFloatField
      FieldName = 'VLR_ICMSSIMPLES'
    end
    object sdsMovVLR_ISSQN: TFloatField
      FieldName = 'VLR_ISSQN'
    end
    object sdsMovVLR_IR: TFloatField
      FieldName = 'VLR_IR'
    end
    object sdsMovVLR_IPI: TFloatField
      FieldName = 'VLR_IPI'
    end
    object sdsMovVLR_INSS: TFloatField
      FieldName = 'VLR_INSS'
    end
    object sdsMovVLR_PIS: TFloatField
      FieldName = 'VLR_PIS'
    end
    object sdsMovVLR_COFINS: TFloatField
      FieldName = 'VLR_COFINS'
    end
    object sdsMovVLR_DUPLICATA: TFloatField
      FieldName = 'VLR_DUPLICATA'
    end
    object sdsMovVLR_CSLL: TFloatField
      FieldName = 'VLR_CSLL'
    end
    object sdsMovVLR_IMPORTACAO: TFloatField
      FieldName = 'VLR_IMPORTACAO'
    end
    object sdsMovVLR_SEGURO: TFloatField
      FieldName = 'VLR_SEGURO'
    end
    object sdsMovVLR_OUTRASDESPESAS: TFloatField
      FieldName = 'VLR_OUTRASDESPESAS'
    end
    object sdsMovVLR_ADUANEIRA: TFloatField
      FieldName = 'VLR_ADUANEIRA'
    end
    object sdsMovBASE_INSS: TFloatField
      FieldName = 'BASE_INSS'
    end
    object sdsMovBASE_ISSQN: TFloatField
      FieldName = 'BASE_ISSQN'
    end
    object sdsMovBASE_ICMS: TFloatField
      FieldName = 'BASE_ICMS'
    end
    object sdsMovBASE_ICMSSIMPLES: TFloatField
      FieldName = 'BASE_ICMSSIMPLES'
    end
    object sdsMovBASE_ICMSSUBST: TFloatField
      FieldName = 'BASE_ICMSSUBST'
    end
    object sdsMovVLR_ISSQN_RETIDO: TFloatField
      FieldName = 'VLR_ISSQN_RETIDO'
    end
    object sdsMovVLR_CSRF: TFloatField
      FieldName = 'VLR_CSRF'
    end
    object sdsMovVLR_LIQUIDO_NFSE: TFloatField
      FieldName = 'VLR_LIQUIDO_NFSE'
    end
    object sdsMovVLR_CUPOMFISCAL: TFloatField
      FieldName = 'VLR_CUPOMFISCAL'
    end
    object sdsMovCANCELADO: TStringField
      FieldName = 'CANCELADO'
      FixedChar = True
      Size = 1
    end
    object sdsMovDENEGADA: TStringField
      FieldName = 'DENEGADA'
      FixedChar = True
      Size = 1
    end
    ...
    object sdsMovUNIDADE: TStringField
      FieldName = 'UNIDADE'
      Size = 3
    end
    ...
    object sdsMovQTD: TFloatField
      FieldName = 'QTD'
    end
    object sdsMovPERC_ICMS: TFloatField
      FieldName = 'PERC_ICMS'
    end
    object sdsMovPERC_IPI: TFloatField
      FieldName = 'PERC_IPI'
    end
    object sdsMovPERC_ICMSSIMPLES: TFloatField
      FieldName = 'PERC_ICMSSIMPLES'
    end
    object sdsMovPERC_PIS: TFloatField
      FieldName = 'PERC_PIS'
    end
    object sdsMovPERC_COFINS: TFloatField
      FieldName = 'PERC_COFINS'
    end
    object sdsMovPERC_ISSQN: TFloatField
      FieldName = 'PERC_ISSQN'
    end
    object sdsMovMOTIVO_CD: TStringField
      FieldName = 'MOTIVO_CD'
      Size = 200
    end
    object sdsMovTP_SAIDA: TStringField
      FieldName = 'TP_SAIDA'
      FixedChar = True
      Size = 1
    end
    object sdsMovTP_ENTRADA: TStringField
      FieldName = 'TP_ENTRADA'
      FixedChar = True
      Size = 1
    end
    object sdsMovTP_SERVICO: TStringField
      FieldName = 'TP_SERVICO'
      FixedChar = True
      Size = 1
    end
    object sdsMovTP_CUPOMFISCAL: TStringField
      FieldName = 'TP_CUPOMFISCAL'
      FixedChar = True
      Size = 1
    end
    object sdsMovNUM_RPS: TIntegerField
      FieldName = 'NUM_RPS'
    end
    object sdsMovNOME_PRODUTO_SERV: TStringField
      FieldName = 'NOME_PRODUTO_SERV'
      Size = 100
    end
    object sdsMovREFERENCIA: TStringField
      FieldName = 'REFERENCIA'
    end
    object sdsMovTAMANHO: TStringField
      FieldName = 'TAMANHO'
      Size = 10
    end
    object sdsMovID_CONDPGTO: TIntegerField
      FieldName = 'ID_CONDPGTO'
    end
    object sdsMovTIPO_CONDICAO: TStringField
      FieldName = 'TIPO_CONDICAO'
      FixedChar = True
      Size = 1
    end
    object sdsMovID_RECIBO: TIntegerField
      FieldName = 'ID_RECIBO'
    end
    object sdsMovID_VENDEDOR: TIntegerField
      FieldName = 'ID_VENDEDOR'
    end
    object sdsMovID_COR: TIntegerField
      FieldName = 'ID_COR'
    end
    object sdsMovPERC_COMISSAO: TFloatField
      FieldName = 'PERC_COMISSAO'
    end
    object sdsMovID_FECHAMENTO: TIntegerField
      FieldName = 'ID_FECHAMENTO'
    end
    object sdsMovVLR_ICMS_UF_REMET: TFloatField
      FieldName = 'VLR_ICMS_UF_REMET'
    end
    object sdsMovVLR_ICMS_UF_DEST: TFloatField
      FieldName = 'VLR_ICMS_UF_DEST'
    end
    object sdsMovTERMINAL_ID: TIntegerField
      FieldName = 'TERMINAL_ID'
    end
    object sdsMovPRECO_CUSTO_TOTAL: TFloatField
      FieldName = 'PRECO_CUSTO_TOTAL'
    end
    object sdsMovVLR_AJUSTE_CUSTO: TFloatField
      FieldName = 'VLR_AJUSTE_CUSTO'
    end
    object sdsMovCHAVE_ACESSO: TStringField
      FieldName = 'CHAVE_ACESSO'
      Size = 44
    end
    object sdsMovTIPO_FRETE: TSmallintField
      FieldName = 'TIPO_FRETE'
    end
    object sdsMovID_SPED_DOC: TIntegerField
      FieldName = 'ID_SPED_DOC'
    end
    object sdsMovCOD_CST_ICMS: TStringField
      FieldName = 'COD_CST_ICMS'
      Size = 3
    end
    object sdsMovORIGEM_PROD: TStringField
      FieldName = 'ORIGEM_PROD'
      Size = 1
    end
    object sdsMovPERC_ICMS_ST: TFloatField
      FieldName = 'PERC_ICMS_ST'
    end
    object sdsMovCOD_CST_IPI: TStringField
      FieldName = 'COD_CST_IPI'
      Size = 2
    end
    object sdsMovCOD_CST_PIS: TStringField
      FieldName = 'COD_CST_PIS'
      Size = 2
    end
    object sdsMovCOD_CST_COFINS: TStringField
      FieldName = 'COD_CST_COFINS'
      Size = 10
    end
  end
  ...
  object cdsMov: TClientDataSet
    ...
    object cdsMovITEM: TIntegerField
      FieldName = 'ITEM'
    end
    ...
    object cdsMovSERIE: TStringField
      FieldName = 'SERIE'
      Size = 3
    end
    ...
    object cdsMovID_SERVICO: TIntegerField
      FieldName = 'ID_SERVICO'
    end
    object cdsMovID_SERVICO_INT: TIntegerField
      FieldName = 'ID_SERVICO_INT'
    end
    object cdsMovID_NOTAFISCAL: TIntegerField
      FieldName = 'ID_NOTAFISCAL'
    end
    object cdsMovID_NOTASERVICO: TIntegerField
      FieldName = 'ID_NOTASERVICO'
    end
    object cdsMovID_CUPOMFISCAL: TIntegerField
      FieldName = 'ID_CUPOMFISCAL'
    end
    object cdsMovID_CFOP: TIntegerField
      FieldName = 'ID_CFOP'
    end
    object cdsMovID_PESSOA: TIntegerField
      FieldName = 'ID_PESSOA'
    end
    object cdsMovID_CLIENTETRIANG: TIntegerField
      FieldName = 'ID_CLIENTETRIANG'
    end
    object cdsMovFILIAL: TIntegerField
      FieldName = 'FILIAL'
    end
    object cdsMovVLR_UNITARIO: TFloatField
      FieldName = 'VLR_UNITARIO'
    end
    object cdsMovVLR_TOTAL: TFloatField
      FieldName = 'VLR_TOTAL'
    end
    object cdsMovVLR_DESCONTO: TFloatField
      FieldName = 'VLR_DESCONTO'
    end
    object cdsMovVLR_FRETE: TFloatField
      FieldName = 'VLR_FRETE'
    end
    object cdsMovVLR_ICMS: TFloatField
      FieldName = 'VLR_ICMS'
    end
    object cdsMovVLR_ICMSSUBST: TFloatField
      FieldName = 'VLR_ICMSSUBST'
    end
    object cdsMovVLR_ICMSSIMPLES: TFloatField
      FieldName = 'VLR_ICMSSIMPLES'
    end
    object cdsMovVLR_ISSQN: TFloatField
      FieldName = 'VLR_ISSQN'
    end
    object cdsMovVLR_IR: TFloatField
      FieldName = 'VLR_IR'
    end
    object cdsMovVLR_IPI: TFloatField
      FieldName = 'VLR_IPI'
    end
    object cdsMovVLR_INSS: TFloatField
      FieldName = 'VLR_INSS'
    end
    object cdsMovVLR_PIS: TFloatField
      FieldName = 'VLR_PIS'
    end
    object cdsMovVLR_COFINS: TFloatField
      FieldName = 'VLR_COFINS'
    end
    object cdsMovVLR_DUPLICATA: TFloatField
      FieldName = 'VLR_DUPLICATA'
    end
    object cdsMovVLR_CSLL: TFloatField
      FieldName = 'VLR_CSLL'
    end
    object cdsMovVLR_IMPORTACAO: TFloatField
      FieldName = 'VLR_IMPORTACAO'
    end
    object cdsMovVLR_SEGURO: TFloatField
      FieldName = 'VLR_SEGURO'
    end
    object cdsMovVLR_OUTRASDESPESAS: TFloatField
      FieldName = 'VLR_OUTRASDESPESAS'
    end
    object cdsMovVLR_ADUANEIRA: TFloatField
      FieldName = 'VLR_ADUANEIRA'
    end
    object cdsMovBASE_INSS: TFloatField
      FieldName = 'BASE_INSS'
    end
    object cdsMovBASE_ISSQN: TFloatField
      FieldName = 'BASE_ISSQN'
    end
    object cdsMovBASE_ICMS: TFloatField
      FieldName = 'BASE_ICMS'
    end
    object cdsMovBASE_ICMSSIMPLES: TFloatField
      FieldName = 'BASE_ICMSSIMPLES'
    end
    object cdsMovBASE_ICMSSUBST: TFloatField
      FieldName = 'BASE_ICMSSUBST'
    end
    object cdsMovVLR_ISSQN_RETIDO: TFloatField
      FieldName = 'VLR_ISSQN_RETIDO'
    end
    object cdsMovVLR_CSRF: TFloatField
      FieldName = 'VLR_CSRF'
    end
    object cdsMovVLR_LIQUIDO_NFSE: TFloatField
      FieldName = 'VLR_LIQUIDO_NFSE'
    end
    object cdsMovVLR_CUPOMFISCAL: TFloatField
      FieldName = 'VLR_CUPOMFISCAL'
    end
    object cdsMovCANCELADO: TStringField
      FieldName = 'CANCELADO'
      FixedChar = True
      Size = 1
    end
    object cdsMovDENEGADA: TStringField
      FieldName = 'DENEGADA'
      FixedChar = True
      Size = 1
    end
    ...
    object cdsMovUNIDADE: TStringField
      FieldName = 'UNIDADE'
      Size = 3
    end
    ...
    object cdsMovQTD: TFloatField
      FieldName = 'QTD'
    end
    object cdsMovPERC_ICMS: TFloatField
      FieldName = 'PERC_ICMS'
    end
    object cdsMovPERC_IPI: TFloatField
      FieldName = 'PERC_IPI'
    end
    object cdsMovPERC_ICMSSIMPLES: TFloatField
      FieldName = 'PERC_ICMSSIMPLES'
    end
    object cdsMovPERC_PIS: TFloatField
      FieldName = 'PERC_PIS'
    end
    object cdsMovPERC_COFINS: TFloatField
      FieldName = 'PERC_COFINS'
    end
    object cdsMovPERC_ISSQN: TFloatField
      FieldName = 'PERC_ISSQN'
    end
    object cdsMovMOTIVO_CD: TStringField
      FieldName = 'MOTIVO_CD'
      Size = 200
    end
    object cdsMovTP_SAIDA: TStringField
      FieldName = 'TP_SAIDA'
      FixedChar = True
      Size = 1
    end
    object cdsMovTP_ENTRADA: TStringField
      FieldName = 'TP_ENTRADA'
      FixedChar = True
      Size = 1
    end
    object cdsMovTP_SERVICO: TStringField
      FieldName = 'TP_SERVICO'
      FixedChar = True
      Size = 1
    end
    object cdsMovTP_CUPOMFISCAL: TStringField
      FieldName = 'TP_CUPOMFISCAL'
      FixedChar = True
      Size = 1
    end
    object cdsMovNUM_RPS: TIntegerField
      FieldName = 'NUM_RPS'
    end
    object cdsMovNOME_PRODUTO_SERV: TStringField
      FieldName = 'NOME_PRODUTO_SERV'
      Size = 100
    end
    object cdsMovREFERENCIA: TStringField
      FieldName = 'REFERENCIA'
    end
    object cdsMovTAMANHO: TStringField
      FieldName = 'TAMANHO'
      Size = 10
    end
    object cdsMovID_CONDPGTO: TIntegerField
      FieldName = 'ID_CONDPGTO'
    end
    object cdsMovTIPO_CONDICAO: TStringField
      FieldName = 'TIPO_CONDICAO'
      FixedChar = True
      Size = 1
    end
    object cdsMovID_RECIBO: TIntegerField
      FieldName = 'ID_RECIBO'
    end
    object cdsMovID_VENDEDOR: TIntegerField
      FieldName = 'ID_VENDEDOR'
    end
    object cdsMovID_COR: TIntegerField
      FieldName = 'ID_COR'
    end
    object cdsMovPERC_COMISSAO: TFloatField
      FieldName = 'PERC_COMISSAO'
    end
    object cdsMovID_FECHAMENTO: TIntegerField
      FieldName = 'ID_FECHAMENTO'
    end
    object cdsMovVLR_ICMS_UF_REMET: TFloatField
      FieldName = 'VLR_ICMS_UF_REMET'
    end
    object cdsMovVLR_ICMS_UF_DEST: TFloatField
      FieldName = 'VLR_ICMS_UF_DEST'
    end
    object cdsMovTERMINAL_ID: TIntegerField
      FieldName = 'TERMINAL_ID'
    end
    object cdsMovPRECO_CUSTO_TOTAL: TFloatField
      FieldName = 'PRECO_CUSTO_TOTAL'
    end
    object cdsMovVLR_AJUSTE_CUSTO: TFloatField
      FieldName = 'VLR_AJUSTE_CUSTO'
    end
    object cdsMovCHAVE_ACESSO: TStringField
      FieldName = 'CHAVE_ACESSO'
      Size = 44
    end
    object cdsMovTIPO_FRETE: TSmallintField
      FieldName = 'TIPO_FRETE'
    end
    object cdsMovID_SPED_DOC: TIntegerField
      FieldName = 'ID_SPED_DOC'
    end
    object cdsMovCOD_CST_ICMS: TStringField
      FieldName = 'COD_CST_ICMS'
      Size = 3
    end
    object cdsMovORIGEM_PROD: TStringField
      FieldName = 'ORIGEM_PROD'
      Size = 1
    end
    object cdsMovPERC_ICMS_ST: TFloatField
      FieldName = 'PERC_ICMS_ST'
    end
    object cdsMovCOD_CST_IPI: TStringField
      FieldName = 'COD_CST_IPI'
      Size = 2
    end
    object cdsMovCOD_CST_PIS: TStringField
      FieldName = 'COD_CST_PIS'
      Size = 2
    end
    object cdsMovCOD_CST_COFINS: TStringField
      FieldName = 'COD_CST_COFINS'
      Size = 10
    end
  end
  object mEncontrada: TClientDataSet
    Active = True
    Aggregates = <>
    Params = <>
    Left = 992
    Top = 528
    Data = {
      600000009619E0BD0100000018000000030000000000030000006000084E4665
      43686176650100490000000100055749445448020002002C00074E756D4E6F74
      610100490000000100055749445448020002000A000444617461040006000000
      00000000}
    object mEncontradaNFeChave: TStringField
      FieldName = 'NFeChave'
      Size = 44
    end
    object mEncontradaNumNota: TStringField
      FieldName = 'NumNota'
      Size = 10
    end
    object mEncontradaData: TDateField
      FieldName = 'Data'
    end
  end
  object dsmEncontrada: TDataSource
    DataSet = mEncontrada
    Left = 1016
    Top = 528
  end
