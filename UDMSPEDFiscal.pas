...
type
  TDMSPEDFiscal = class(TDataModule)
    ...
    sdsMovimentoCOD_CONTABIL_PRO: TStringField;
    sdsMovimentoCOD_CONTABIL_FORN: TStringField;
    cdsMovimentoCOD_CONTABIL_PRO: TStringField;
    cdsMovimentoCOD_CONTABIL_FORN: TStringField;
    mPlano: TClientDataSet;
    sdsMovimentoCONT_PROD_DT_CAD: TDateField;
    sdsMovimentoCONT_PROD_NAT: TIntegerField;
    sdsMovimentoCONT_PROD_TIPO: TStringField;
    sdsMovimentoCONT_PROD_NIVEL: TIntegerField;
    sdsMovimentoCONT_FORN_DT_CAD: TDateField;
    sdsMovimentoCONT_FORN_NAT: TIntegerField;
    sdsMovimentoCONT_FORN_TIPO: TStringField;
    sdsMovimentoCONT_FORN_NIVEL: TIntegerField;
    cdsMovimentoCONT_PROD_DT_CAD: TDateField;
    cdsMovimentoCONT_PROD_NAT: TIntegerField;
    cdsMovimentoCONT_PROD_TIPO: TStringField;
    cdsMovimentoCONT_PROD_NIVEL: TIntegerField;
    cdsMovimentoCONT_FORN_DT_CAD: TDateField;
    cdsMovimentoCONT_FORN_NAT: TIntegerField;
    cdsMovimentoCONT_FORN_TIPO: TStringField;
    cdsMovimentoCONT_FORN_NIVEL: TIntegerField;
    mPlanoDTALT: TDateField;
    mPlanoCOD_NAT: TIntegerField;
    mPlanoTIPO_REG: TStringField;
    mPlanoNIVEL: TIntegerField;
    mPlanoCOD_CTA: TStringField;
    mPlanoNOME_CTA: TStringField;
    sdsMovimentoCONT_PROD_NOME: TStringField;
    sdsMovimentoCONT_FORN_NOME: TStringField;
    cdsMovimentoCONT_PROD_NOME: TStringField;
    cdsMovimentoCONT_FORN_NOME: TStringField;
    ...
    sdsSped_Doc_Itens: TSQLDataSet;
    dspSped_Doc_Itens: TDataSetProvider;
    cdsSped_Doc_Itens: TClientDataSet;
    cdsSped_Doc_ItensID: TIntegerField;
    cdsSped_Doc_ItensITEM: TIntegerField;
    cdsSped_Doc_ItensTIPO_REG: TStringField;
    cdsSped_Doc_ItensTIPO_MOV: TStringField;
    cdsSped_Doc_ItensSERIE: TStringField;
    cdsSped_Doc_ItensNUM_NOTA: TIntegerField;
    cdsSped_Doc_ItensID_PRODUTO: TIntegerField;
    cdsSped_Doc_ItensID_SERVICO: TIntegerField;
    cdsSped_Doc_ItensID_SERVICO_INT: TIntegerField;
    cdsSped_Doc_ItensID_NOTAFISCAL: TIntegerField;
    cdsSped_Doc_ItensID_NOTASERVICO: TIntegerField;
    cdsSped_Doc_ItensID_CUPOMFISCAL: TIntegerField;
    cdsSped_Doc_ItensID_CFOP: TIntegerField;
    cdsSped_Doc_ItensID_PESSOA: TIntegerField;
    cdsSped_Doc_ItensID_CLIENTETRIANG: TIntegerField;
    cdsSped_Doc_ItensFILIAL: TIntegerField;
    cdsSped_Doc_ItensVLR_UNITARIO: TFloatField;
    cdsSped_Doc_ItensVLR_TOTAL: TFloatField;
    cdsSped_Doc_ItensVLR_DESCONTO: TFloatField;
    cdsSped_Doc_ItensVLR_FRETE: TFloatField;
    cdsSped_Doc_ItensVLR_ICMS: TFloatField;
    cdsSped_Doc_ItensVLR_ICMSSUBST: TFloatField;
    cdsSped_Doc_ItensVLR_ICMSSIMPLES: TFloatField;
    cdsSped_Doc_ItensVLR_ISSQN: TFloatField;
    cdsSped_Doc_ItensVLR_IR: TFloatField;
    cdsSped_Doc_ItensVLR_IPI: TFloatField;
    cdsSped_Doc_ItensVLR_INSS: TFloatField;
    cdsSped_Doc_ItensVLR_PIS: TFloatField;
    cdsSped_Doc_ItensVLR_COFINS: TFloatField;
    cdsSped_Doc_ItensVLR_DUPLICATA: TFloatField;
    cdsSped_Doc_ItensVLR_CSLL: TFloatField;
    cdsSped_Doc_ItensVLR_IMPORTACAO: TFloatField;
    cdsSped_Doc_ItensVLR_SEGURO: TFloatField;
    cdsSped_Doc_ItensVLR_OUTRASDESPESAS: TFloatField;
    cdsSped_Doc_ItensVLR_ADUANEIRA: TFloatField;
    cdsSped_Doc_ItensBASE_INSS: TFloatField;
    cdsSped_Doc_ItensBASE_ISSQN: TFloatField;
    cdsSped_Doc_ItensBASE_ICMS: TFloatField;
    cdsSped_Doc_ItensBASE_ICMSSIMPLES: TFloatField;
    cdsSped_Doc_ItensBASE_ICMSSUBST: TFloatField;
    cdsSped_Doc_ItensVLR_ISSQN_RETIDO: TFloatField;
    cdsSped_Doc_ItensVLR_CSRF: TFloatField;
    cdsSped_Doc_ItensVLR_LIQUIDO_NFSE: TFloatField;
    cdsSped_Doc_ItensVLR_CUPOMFISCAL: TFloatField;
    cdsSped_Doc_ItensCANCELADO: TStringField;
    cdsSped_Doc_ItensDENEGADA: TStringField;
    cdsSped_Doc_ItensDTEMISSAO: TDateField;
    cdsSped_Doc_ItensDTENTRADASAIDA: TDateField;
    cdsSped_Doc_ItensUNIDADE: TStringField;
    cdsSped_Doc_ItensTIPO_ES: TStringField;
    cdsSped_Doc_ItensQTD: TFloatField;
    cdsSped_Doc_ItensPERC_ICMS: TFloatField;
    cdsSped_Doc_ItensPERC_IPI: TFloatField;
    cdsSped_Doc_ItensPERC_ICMSSIMPLES: TFloatField;
    cdsSped_Doc_ItensPERC_PIS: TFloatField;
    cdsSped_Doc_ItensPERC_COFINS: TFloatField;
    cdsSped_Doc_ItensPERC_ISSQN: TFloatField;
    cdsSped_Doc_ItensMOTIVO_CD: TStringField;
    cdsSped_Doc_ItensTP_SAIDA: TStringField;
    cdsSped_Doc_ItensTP_ENTRADA: TStringField;
    cdsSped_Doc_ItensTP_SERVICO: TStringField;
    cdsSped_Doc_ItensTP_CUPOMFISCAL: TStringField;
    cdsSped_Doc_ItensNUM_RPS: TIntegerField;
    cdsSped_Doc_ItensNOME_PRODUTO_SERV: TStringField;
    cdsSped_Doc_ItensREFERENCIA: TStringField;
    cdsSped_Doc_ItensTAMANHO: TStringField;
    cdsSped_Doc_ItensID_CONDPGTO: TIntegerField;
    cdsSped_Doc_ItensTIPO_CONDICAO: TStringField;
    cdsSped_Doc_ItensID_RECIBO: TIntegerField;
    cdsSped_Doc_ItensID_VENDEDOR: TIntegerField;
    cdsSped_Doc_ItensID_COR: TIntegerField;
    cdsSped_Doc_ItensPERC_COMISSAO: TFloatField;
    cdsSped_Doc_ItensID_FECHAMENTO: TIntegerField;
    cdsSped_Doc_ItensVLR_ICMS_UF_REMET: TFloatField;
    cdsSped_Doc_ItensVLR_ICMS_UF_DEST: TFloatField;
    cdsSped_Doc_ItensTERMINAL_ID: TIntegerField;
    cdsSped_Doc_ItensPRECO_CUSTO_TOTAL: TFloatField;
    cdsSped_Doc_ItensVLR_AJUSTE_CUSTO: TFloatField;
    cdsSped_Doc_ItensCHAVE_ACESSO: TStringField;
    cdsSped_Doc_ItensTIPO_FRETE: TSmallintField;
    cdsSped_Doc_ItensID_SPED_DOC: TIntegerField;
    cdsSped_Doc_ItensUNIDADE_PRODUTO_CAD: TStringField;
    cdsSped_Doc_ItensNOME_PRODUTO_CAD: TStringField;
    cdsSped_Doc_ItensCOD_BARRA_CAD: TStringField;
    cdsSped_Doc_ItensSPED_TIPO_ITEM: TStringField;
    cdsSped_Doc_ItensNCM: TStringField;
    cdsSped_Doc_ItensCODCFOP: TStringField;
    cdsSped_Doc_ItensNOME_CFOP: TStringField;
    cdsSped_Doc_ItensUSA_TAMANHO_AGRUPADO_NFE: TStringField;
    cdsSped_Doc_ItensNCM_EX: TStringField;
    cdsSped_Doc_ItensCOD_CONTABIL_PRO: TStringField;
    cdsSped_Doc_ItensCOD_CONTABIL_FORN: TStringField;
    cdsSped_Doc_ItensCONT_PROD_DT_CAD: TDateField;
    cdsSped_Doc_ItensCONT_PROD_NAT: TIntegerField;
    cdsSped_Doc_ItensCONT_PROD_TIPO: TStringField;
    cdsSped_Doc_ItensCONT_PROD_NIVEL: TIntegerField;
    cdsSped_Doc_ItensCONT_PROD_NOME: TStringField;
    cdsSped_Doc_ItensCONT_FORN_DT_CAD: TDateField;
    cdsSped_Doc_ItensCONT_FORN_NAT: TIntegerField;
    cdsSped_Doc_ItensCONT_FORN_TIPO: TStringField;
    cdsSped_Doc_ItensCONT_FORN_NIVEL: TIntegerField;
    cdsSped_Doc_ItensCONT_FORN_NOME: TStringField;
    cdsSped_Doc_ItensCOD_CST_ICMS: TStringField;
    cdsSped_Doc_ItensORIGEM_PROD: TStringField;
    cdsSped_DocREGIME_TRIB: TSmallintField;
    cdsSped_Doc_ItensPERC_ICMS_ST: TFloatField;
    cdsSped_Doc_ItensCOD_CST_IPI: TStringField;
    cdsSped_Doc_ItensCOD_CST_PIS: TStringField;
    cdsSped_Doc_ItensCOD_CST_COFINS: TStringField;
    mC175: TClientDataSet;
    mC175CST_PIS: TStringField;
    mC175CST_COFINS: TStringField;
    mC175CodCFOP: TStringField;
    mC175Vlr_Total: TFloatField;
    mC175Vlr_Desconto: TFloatField;
    mC175Perc_Pis: TFloatField;
    mC175Vlr_Pis: TFloatField;
    mC175Perc_Cofins: TFloatField;
    mC175Vlr_Cofins: TFloatField;
    mM100: TClientDataSet;
    mM100Cod_Cred: TStringField;
    mM100Ind_Cred_Ori: TIntegerField;
    mM100Vlr_Base_Pis: TFloatField;
    mM100Perc_Pis: TFloatField;
    mM100Quant_BC_Pis: TFloatField;
    mM100Perc_Pis_Quant: TFloatField;
    mM100Vlr_Credito: TFloatField;
    mM100Vlr_Ajuste_Acrescimo: TFloatField;
    mM100Vlr_Ajuste_Reducao: TFloatField;
    mM100Vlr_Diferido: TFloatField;
    mM100Vlr_Credito_Disp: TFloatField;
    mM105: TClientDataSet;
    mM105Nat_BC_Cred: TStringField;
    mM105CST_PIS: TIntegerField;
    mM105Vlr_Total: TFloatField;
    mM105VL_BC_PIS_NC: TFloatField;
    mM105VL_BC_PIS: TFloatField;
    mM210: TClientDataSet;
    mM210COD_CONT: TStringField;
    mM210VL_REC_BRT: TFloatField;
    mM210VL_BC_CONT: TFloatField;
    mM210ALIQ_PIS: TFloatField;
    mM210QUANT_BC_PIS: TFloatField;
    mM210ALIQ_PIS_QUANT: TFloatField;
    mM210VL_CONT_APUR: TFloatField;
    mM210VL_AJUS_ACRES: TFloatField;
    mM210VL_AJUS_REDUC: TFloatField;
    mM210VL_CONT_DIFER: TFloatField;
    mM210VL_CONT_DIFER_ANT: TFloatField;
    mM210VL_CONT_PER: TFloatField;
    mM400: TClientDataSet;
    mM400CST_PIS: TStringField;
    mM400VL_TOT_REC: TFloatField;
    mM400COD_CTA: TStringField;
    mM400DESC_COMPL: TStringField;
    mM100Tipo: TStringField;
    mM105Tipo: TStringField;
    mM210Tipo: TStringField;
    mM400Tipo: TStringField;
    qPlanoContas: TSQLQuery;
    qPlanoContasID: TIntegerField;
    qPlanoContasCODIGO: TStringField;
    qPlanoContasNOME: TStringField;
    qPlanoContasDT_CADASTRO: TDateField;
    qPlanoContasNIVEL: TIntegerField;
    qPlanoContasTIPO_REG: TStringField;
    qPlanoContasCOD_NATUREZA: TIntegerField;
    qPlanoContasINATIVO: TStringField;
    qPlanoContasSUPERIOR: TIntegerField;
    qPlanoContasDT_INICIO_VALIDADE: TDateField;
    qPlanoContasDT_FINAL_VALIDADE: TDateField;
    mC175COD_CTA: TStringField;
    sdsMov_Pessoa: TSQLDataSet;
    dspMov_Pessoa: TDataSetProvider;
    cdsMov_Pessoa: TClientDataSet;
    cdsMov_PessoaID_PESSOA: TIntegerField;
    cdsMov_PessoaNOME: TStringField;
    cdsMov_PessoaCODPAIS: TStringField;
    cdsMov_PessoaCNPJ_CPF: TStringField;
    cdsMov_PessoaINSCR_EST: TStringField;
    cdsMov_PessoaCODMUNICIPIO: TStringField;
    cdsMov_PessoaENDERECO: TStringField;
    cdsMov_PessoaNUM_END: TStringField;
    cdsMov_PessoaCOMPLEMENTO_END: TStringField;
    cdsMov_PessoaBAIRRO: TStringField;
    cdsMov_PessoaCIDADE: TStringField;
    cdsMov_PessoaPESSOA: TStringField;
    sdsMov_Unidade: TSQLDataSet;
    dspMov_Unidade: TDataSetProvider;
    cdsMov_Unidade: TClientDataSet;
    cdsMov_UnidadeUNIDADE: TStringField;
    cdsMov_UnidadeNOME: TStringField;
    cdsMov_UnidadeFATOR: TIntegerField;
    sdsMov_Produto: TSQLDataSet;
    dspMov_Produto: TDataSetProvider;
    cdsMov_Produto: TClientDataSet;
    cdsMov_ProdutoID_PRODUTO: TIntegerField;
    cdsMov_ProdutoREFERENCIA: TStringField;
    cdsMov_ProdutoNOME: TStringField;
    cdsMov_ProdutoCOD_BARRA: TStringField;
    cdsMov_ProdutoUNIDADE: TStringField;
    cdsMov_ProdutoSPED_TIPO_ITEM: TStringField;
    cdsMov_ProdutoNCM: TStringField;
    cdsMov_ProdutoNCM_EX: TStringField;
    cdsMov_ProdutoEX_IPI: TIntegerField;
    cdsMov_ProdutoPERC_ICMS: TFloatField;
    sdsMov_Natureza: TSQLDataSet;
    dspMov_Natureza: TDataSetProvider;
    cdsMov_Natureza: TClientDataSet;
    cdsMov_NaturezaID_CFOP: TIntegerField;
    cdsMov_NaturezaCODCFOP: TStringField;
    cdsMov_NaturezaNOME: TStringField;
    mM200: TClientDataSet;
    mM200VL_TOT_CONT_NC_PER: TFloatField;
    mM200VL_TOT_CRED_DESC: TFloatField;
    mM200VL_TOT_CRED_DESC_ANT: TFloatField;
    mM200VL_TOT_CONT_NC_DEV: TFloatField;
    mM200VL_RET_NC: TFloatField;
    mM200VL_OUT_DED_NC: TFloatField;
    mM200VL_CONT_NC_REC: TFloatField;
    mM200VL_TOT_CONT_CUM_PER: TFloatField;
    mM200VL_RET_CUM: TFloatField;
    mM200VL_OUT_DED_CUM: TFloatField;
    mM200VL_CONT_CUM_REC: TFloatField;
    mM200VL_TOT_CONT_REC: TFloatField;
    mM200Tipo: TStringField;
    sdsMov_PisCofins: TSQLDataSet;
    dspMov_PisCofins: TDataSetProvider;
    cdsMov_PisCofins: TClientDataSet;
    cdsMov_PisCofinsVLR_TOTAL: TFloatField;
    cdsMov_PisCofinsVLR_PIS: TFloatField;
    cdsMov_PisCofinsVLR_COFINS: TFloatField;
    cdsMov_PisCofinsPERC_PIS: TFloatField;
    cdsMov_PisCofinsPERC_COFINS: TFloatField;
    sdsMov_CSTPISCofins: TSQLDataSet;
    dspMov_CSTPISCofins: TDataSetProvider;
    cdsMov_CSTPISCofins: TClientDataSet;
    cdsMov_CSTPISCofinsVLR_TOTAL: TFloatField;
    cdsMov_CSTPISCofinsVLR_PIS: TFloatField;
    cdsMov_CSTPISCofinsVLR_COFINS: TFloatField;
    cdsMov_CSTPISCofinsCOD_CST_PIS: TStringField;
    cdsMov_CSTPISCofinsCOD_CST_COFINS: TStringField;
    sdsMov_TotalPisCofins: TSQLDataSet;
    dspMov_TotalPisCofins: TDataSetProvider;
    cdsMov_TotalPisCofins: TClientDataSet;
    cdsMov_TotalPisCofinsVLR_PIS: TFloatField;
    cdsMov_TotalPisCofinsVLR_COFINS: TFloatField;
    cdsMov_TotalPisCofinsVLR_BASE: TFloatField;
    cdsMov_TotalPisCofinsVLR_TOTAL: TFloatField;
    sdsMov_SemPisCofins: TSQLDataSet;
    dspMov_SemPisCofins: TDataSetProvider;
    cdsMov_SemPisCofins: TClientDataSet;
    cdsMov_SemPisCofinsVLR_TOTAL: TFloatField;
    cdsMov_SemPisCofinsCOD_CST_PIS: TStringField;
    cdsMov_SemPisCofinsCOD_CST_COFINS: TStringField;
